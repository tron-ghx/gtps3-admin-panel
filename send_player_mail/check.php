...
$username = strtolower(clean_string($_POST['name']));
$email = strtolower($_POST['email']);
if (empty($username)) $username= clean_string($_GET['name']);
if (empty($email)) $email = $_GET['email'];
$serverfiles = "C:/Users/admin/Desktop/GTPS3/players/";
...
if (strtolower($contentsDecoded['email']) == $email) {
...
echo "<div class='text-success text-success-wrapper'>
  ...
  $url = "https://privategt.com/account/email.php";
